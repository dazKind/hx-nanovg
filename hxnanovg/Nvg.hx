...
extern class Nvg {
    ...
    @:native("::nvgArc")
    public static function arc(_ctx:Pointer<NvgContext>, _cx:Int, _cy:Int, _r:Float, _a0:Float, _a1:Float, _dir:Int):Void;

    @:native("::nvgRect")
    public static function rect(_ctx:Pointer<NvgContext>, _x:Int, _y:Int, _w:Float, _h:Float):Void;

    @:native("::nvgRoundedRect")
    public static function roundedRect(_ctx:Pointer<NvgContext>, _x:Int, _y:Int, _w:Float, _h:Float, _r:Float):Void;

    @:native("::nvgEllipse")
    public static function ellipse(_ctx:Pointer<NvgContext>, _cx:Int, _cy:Int, _rx:Float, _ry:Float):Void;
    ...
    @:native("::nvgText")
    public static function text(_ctx:Pointer<NvgContext>, _x:Float, _y:Float, _string:ConstPointer<Char>, _end:ConstPointer<Char>):Float;

    @:native("::nvgTextBox")
    public static function textBox(_ctx:Pointer<NvgContext>, _x:Float, _y:Float, _breakRowWidth:Float, _string:ConstPointer<Char>, _end:ConstPointer<Char>):Void;

    @:native("::nvgTextBounds")
    public static function textBounds(_ctx:Pointer<NvgContext>, _x:Float, _y:Float, _string:ConstPointer<Char>, _end:ConstPointer<Char>, _bounds:Pointer<Float>):Float;

    @:native("::nvgTextBoxBounds")
    public static function textBoxBounds(_ctx:Pointer<NvgContext>, _x:Float, _y:Float, _breakRowWidth:Float, _string:ConstPointer<Char>, _end:ConstPointer<Char>, _bounds:Pointer<Float>):Void;

    @:native("::nvgTextGlyphPositions")
    public static function textGlyphPositions(_ctx:Pointer<NvgContext>, _x:Float, _y:Float, _string:ConstPointer<Char>, _end:ConstPointer<Char>, _positions:Pointer<NvgGlyphPosition>, _maxPositions:Int):Int;
